...
| `10g-tcp.json` | 10 Gbps | TCP | 8 | Current (PCIe M.2 NIC) |
| `10g-udp.json` | 10 Gbps | UDP | 8 | Current (PCIe M.2 NIC) |
...
- **Current** tiers are achievable on Pi 5 hardware today.
- **Future** tiers are for forward-looking parser testing; the hardware may not exist yet for Pi.
